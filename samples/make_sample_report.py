...
This is a test fixture for the PDF drag-and-drop: it contains a clinical history
(phenotypes) and a results table (reported variants) that the AI edge should be
able to read back into the tool.

    python samples/make_sample_report.py        # writes samples/sample_lab_report.pdf
